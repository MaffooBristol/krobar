(function (App) {
  ...
  App.getFilesCollection = function (options) {
    const Collection = Backbone.Collection.extend({
      ...
      sortTraktorEntry (a, b) {
        return 0;
        return a.loudness - b.loudness;
      },
      fetchTraktorCollection (callback) {
      ...
      calculateAverageBPM () {
        ...
        const bpms = _.compact(this.pluck('bpm'));
        collection.avgBPM = Math.round(_.reduce(bpms, (a, b, c) => {
          a = parseInt(a, 10);
